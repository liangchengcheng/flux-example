package mddemo.library.com.actions;

import mddemo.library.com.dispatcher.Dispatcher;
import mddemo.library.com.model.Todo;

/**
 * Created by chengcheng on 2015/11/28.
 */
public class ActionsCreator {
    private static ActionsCreator instance;
    final Dispatcher dispatcher;

    ActionsCreator(Dispatcher dispatcher){this.dispatcher=dispatcher;}
    ...
    public void create(String text){
        dispatcher.dispatch(TodoActions.TODO_CREATE,TodoActions.KEY_TEXT,text);
    }
